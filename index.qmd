...
¿Cómo describirías la comunicación entre autora/es y revisora/es en la academia y rOpenSci?
:::
...
También vas a necesitar ejecutar `pkgstats::ctags_install()` en Linux, o `brew install global` desde la terminal en MacOS.
:::
...
::: {.callout-note icon=false}
### ¿Qué puntaje le darías a cada respuesta de la editoría (1-10)?
...
::: {.callout-note icon=false}
## Abrir un issue para proponer software para revisión en el [repositorio de práctica](https://github.com/ropensci-training/software-review/issues)
...
Recibimos varios paquetes desarrollados con IA y con un historial de commits muy corto. Para hacer frente a este desafío, JOSS requiere un historial de commits de al menos seis meses.

- Contanos si/cómo usás IA
- Compartí tu opinión sobre si rOpenSci debería imitar la política de JOSS.
:::

:::aside
[*Los proyectos desarrollados de forma privada no son elegibles hasta que exista un historial público de ... al menos seis meses -- JOSS*](https://joss.readthedocs.io/en/latest/submitting.html#scope-and-significance)
:::
...
Generá, interpretá, y respondé a los resultados de [{pkgcheck}](https://docs.ropensci.org/pkgcheck/)
...
::: {.callout-note icon=false}
### Proponé (solo) una mejora. Usá la [plantilla de revisión](https://devdevguide.netlify.app/es/reviewtemplate.es.html).
...
- Guía de desarrollo [standard](https://devdevguide.netlify.app/es/index.es) y [estadistico](https://stats-devguide.ropensci.org)
  - Categorías de paquetes [standard](https://devdevguide.netlify.app/es/softwarereview_policies.es.html#package-categories) y [estadistico](https://stats-devguide.ropensci.org/overview.html#overview-categories)
...
- [pkgmatch](https://docs.ropensci.org/pkgmatch) ([ejemplo](https://github.com/ropensci/software-review/issues/766#issuecomment-4660730235))
