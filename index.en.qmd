...
About [you](https://ropensci.org/es/champions/) 🏅🇪🇸 and about [me](https://ropensci.org/author/mauro-lepore/) 👋.
...
<details><summary>End-to-end process introduction</summary>
...
<details><summary>Proposing software for review</summary>
- Opening an issue
...
About how we work with [software](https://devguide.ropensci.org/es/index.es.html) and [people](https://ropensci.org/es/c%C3%B3digo-de-conducta/)
...
:::aside
[Bot commands](https://devguide.ropensci.org/es/bot_cheatsheet.es.html)
:::
...
:::aside
[Code of Conduct](https://ropensci.org/es/c%C3%B3digo-de-conducta/)
:::
...
<sub>
[Responding to out-of-scope submissions](https://devdevguide.netlify.app/es/softwarereview_editor.es#outofscoperesponse)
</sub>
...
```r
# pak::pak()
out <- pkgcheck::pkgcheck("saperlipopette")
summary(out)
...
<sub>
[Responding to reviewer questions](https://devdevguide.netlify.app/es/softwarereview_editor.es#reviewersupport)
</sub>
...
[Volunteer here](https://devdevguide.netlify.app/es/softwarereview_reviewer.es#volunteering-as-a-reviewer)
...
- [Dev Guide](https://devdevguide.netlify.app/es/index.es)
  - [Package categories](https://devdevguide.netlify.app/es/softwarereview_policies.es.html#package-categories)
  - [For package authors](https://devdevguide.netlify.app/es/softwarereview_author.es)
  - [For reviewers](https://devdevguide.netlify.app/es/softwarereview_reviewer.es)
- [Statistical Software Guide](https://stats-devguide.ropensci.org/)
- [pkgcheck](https://docs.ropensci.org/pkgcheck/)
- [Review template](https://devdevguide.netlify.app/es/reviewtemplate.es)

Blogs about the review process

- [Software Review, Perspectives from an Academic](https://ropensci.org/es/blog/2025/03/25/r-package-review/)
- [First-time Experiences Reviewing rOpenSci Packages](https://ropensci.org/es/blog/2017/09/08/first-review-experiences/)
- [So You (Don't) Think You Can Review a Package](https://ropensci.org/es/blog/2017/08/22/first-package-review/)
...
[Volunteer as a reviewer](https://devdevguide.netlify.app/es/softwarereview_reviewer.es#volunteering-as-a-reviewer)
