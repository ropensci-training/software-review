...
How would you describe communication between authors and reviewers in academia and rOpenSci?
...
- [Collaborative document](https://docs.google.com/document/d/1IJ1aD5VmYzO1zr61YteLkcrzb-8LzQMp1QRzByjwIPA/edit?usp=sharing)
...
- Dev Guide [standard](https://devdevguide.netlify.app/index) and [statistical](https://stats-devguide.ropensci.org)
  - Package categories [standard](https://devdevguide.netlify.app/softwarereview_policies.html#package-categories) and [statistical](https://stats-devguide.ropensci.org/overview.html#overview-categories)
...
- [pkgmatch](https://docs.ropensci.org/pkgmatch) ([example](https://github.com/ropensci/software-review/issues/766#issuecomment-4660730235))
